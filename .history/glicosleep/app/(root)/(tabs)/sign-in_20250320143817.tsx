...
const SignIn = ({ onNavigateToRegister }: { onNavigateToRegister: () => void }) => {
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "white", flex: 1 }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        {/* Botão para Registro */}
        <TouchableOpacity
          onPress={onNavigateToRegister} // Chama a prop para alternar para a tela de registro
          style={{
            marginTop: 20,
            alignSelf: "center",
          }}
        >
          <Text style={{ color: "#007BFF", fontWeight: "bold" }}>Não tem uma conta? Registre-se</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
