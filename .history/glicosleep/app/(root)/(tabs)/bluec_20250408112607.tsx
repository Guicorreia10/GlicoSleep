 // In your (tabs)/bluec.tsx file
 import React, { useState, useEffect } from 'react';
 import { View, Text, StyleSheet, TouchableOpacity, FlatList } from 'react-native';
 import { useNavigation } from '@react-navigation/native';
 import { BleManager } from 'react-native-ble-plx'; // Corrected import
 ...
 const Bluec = () => {
  ...
  const bluetooth = new BleManager(); // Corrected initialization
  ...
  }, (error) => { // Explicitly type the error parameter
