...
const pickImage = async () => {
  ...
  if (!result.canceled) {
    console.log(result.assets[0].uri); // Resultado da imagem selecionada
  }
}; // Certifique-se de incluir esta chave para fechar a função
    ...
    <SafeAreaView className="bg-white h-full">
      ...
      >
        ...
        <View className="flex flex-col mt-10">
          ...
          <SettingsItem icon ={icons.wallet} title="O Meu Historico" onPress={() => {}}/>
        ...
        <View className="flex flex-col mt-5 border-t pt-5 border-primary-200"></View>
            <SettingsItem icon={icons.logout} title="Terminar Sessão"  showArrow={false} onPress={handleLogout}/>
