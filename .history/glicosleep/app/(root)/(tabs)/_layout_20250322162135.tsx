    ...
    return (
        <Tabs
            screenOptions={{
                ...
                tabBarStyle: {
                    position: 'absolute',
                    bottom: 20, // Eleva a barra
                    left: 15,
                    right: 15,
                    backgroundColor: '#1E90FF', // Azul mais vibrante
                    borderRadius: 25, // Arredondamento elegante
                    borderTopWidth: 0, // Remove a borda superior padrão
                    shadowColor: '#000', // Adiciona sombra
                    shadowOffset: { width: 0, height: 5 },
                    shadowOpacity: 0.25, // Sombra sutil
                    shadowRadius: 10,
                    elevation: 8, // Sombra no Android
                    height: 75, // Altura personalizada
                },
            }}
        >
            <Tabs.Screen
