...
const SignIn = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      // Verificar se o login foi bem-sucedido e redirecionar para a página inicial
      if (data?.session) {
        router.replace("/"); // Usando router.replace para evitar voltar ao login
      } else {
  ...
  return (
    <View style={{ flex: 1, justifyContent: "center", padding: 20 }}>
      ...
      <Image
        ...
        style={{
          width: '100%',
          height: 400, // Ajuste de altura para visualização
          marginBottom: 30,
        }}
      />
