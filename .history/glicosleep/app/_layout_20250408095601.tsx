...
export default function RootLayout() {
 ...
 const [fontsLoading, setFontsLoading] = useState(true); // Novo estado para controlar o carregamento das fontes
 ...
 setFontsLoading(false); // Define fontsLoading como false quando as fontes são carregadas
 }
