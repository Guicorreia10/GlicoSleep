...
const SignIn = () => {
 ...
 // Alert.alert("Sucesso", "Login realizado com sucesso!"); // Removido o alerta
 router.push("/"); // 👈 Usando router.push em vez de router.replace
 } catch (error: any) {
 ...
 style={{
 width: '100%',
 height: 400, // 👈 Aumentei a altura da imagem aqui
 marginBottom: 30,
 }}
 />
