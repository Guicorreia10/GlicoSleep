  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.deviceTypeContainer}>
        ...
        >
          <Image
            source={require("../assets/images/smartwatch.png")} // Substitua pela imagem correta
        ...
        >
          <Image
            source={require("../assets/images/glucose-monitor.png")} // Substitua pela imagem correta
            style={styles.deviceTypeIcon}
          />
